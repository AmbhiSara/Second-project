            ...
            <div class="row justify-content-center">
                <div class="col-sm-10">
                    <div class="card">
                        ...
                        <div class="row mp-3">
                                <div class="col-md-6">
                                    <img src="../../images/image7.jpg" width="100%" height="1000px">
                                </div>
    ...
    <form>
                                <div class="row mp-3">
                                    <div class="col-md-6">
                                       ...
                                       <input type="text" id="admission_no" name="admission_no" placeholder="Enter  admission_no...."  class="form-control" value="{{$students->admission_no}}">
                                     </div>
                                </div>
                        <h1></h1>
                                <div class="row mp-3">
                                     <div class="col-md-6">
                                        ...
                                        <input type="text" id="first_name" name="first_name" placeholder="Enter first name.."  class="form-control" value="{{$students->first_name}}">
                                     </div>
                                     <div class="col-md-6">
                                        <label for="lname" class="form-label fw-bold">Last Name</label>
                                        <input type="text" id="lname" name="last_name" placeholder="Enter last name.."  class="form-control" value="{{$students->last_name}}">
                                     </div>
                                </div>
                        <h1></h1>
                                <div class="row mp-3">
                            ...
                            <h1></h1>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" id="dob" name="dob" value={{$students->dob}} class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="nic" class="form-label fw-bold">NIC</label>
                                        <input type="text" id="nic" name="nic" value={{$students->nic}}  placeholder="Enter NIC No..."  class="form-control">
                                    </div>
                                </div>
                            <h1></h1>
                                <div class="row g-3">
                                    ...
                                    <div class="col-75">
                                        <textarea id="address" name="address" placeholder="Write something.." style="height:100px"  class="form-control">{{$students->address}} </textarea>
                                    </div>
                                </div>
                            <h1></h1>
                            <br>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <input type="submit" value="Update"  class="form-control" style="background-color: #0275d8; color:white;">
                                    </div>
                                    <div class="col-md-6">
